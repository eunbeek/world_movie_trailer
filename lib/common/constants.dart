...
Map<String, Map<String, String>> donateLabels = {
  "ko": {
    ...
    "donateDesc": "작은 기부는 개발팀에 큰 힘이 됩니다. 기부 해 주시면 광고를 완전히 제거 해 드리겠습니다. 항상 감사합니다.",
  ...
  "en": {
    ...
    "donateDesc": "A small donation gives great support to our development team. If you donate, all ads will be completely removed. Thank you always.",
  ...
  "ja": {
    ...
    "donateDesc": "小さなご支援でも開発チームにとって大きな力になります。ご寄付いただければ、広告を完全に削除いたします。いつもありがとうございます。",
  ...
  "zh": {
    ...
    "donateDesc": "您的小额捐赠对我们的开发团队来说是巨大的支持。捐赠后，我们将完全移除所有广告。一直以来感谢您的支持！",
  ...
  "tw": {
    ...
    "donateDesc": "您的小額捐贈對我們的開發團隊來說是莫大的支持。捐贈後，我們將完全移除所有廣告。一直以來感謝您的支持！",
  ...
  "fr": {
    ...
    "donateDesc": "Un petit don représente un grand soutien pour notre équipe de développement. Si vous faites un don, toutes les publicités seront entièrement supprimées. Merci infiniment pour votre soutien constant.",
  ...
  "de": {
    ...
    "donateDesc": "Eine kleine Spende ist eine große Unterstützung für unser Entwicklungsteam. Wenn Sie spenden, werden alle Werbeanzeigen vollständig entfernt. Vielen Dank für Ihre anhaltende Unterstützung.",
  ...
  "es": {
    ...
    "donateDesc": "Una pequeña donación es un gran apoyo para nuestro equipo de desarrollo. Si realizas una donación, eliminaremos por completo todos los anuncios. Muchas gracias por tu apoyo constante.",
  ...
  "hi": {
    ...
    "donateDesc": "आपका छोटा सा दान हमारी डेवलपमेंट टीम के लिए बहुत बड़ी मदद है। यदि आप दान करते हैं, तो हम सभी विज्ञापनों को पूरी तरह से हटा देंगे। हमेशा समर्थन करने के लिए धन्यवाद।",
  ...
  "th": {
    ...
    "donateDesc": "การบริจาคเล็กน้อยคือกำลังใจที่ยิ่งใหญ่สำหรับทีมพัฒนาของเรา หากคุณบริจาค เราจะลบโฆษณาทั้งหมดออกอย่างถาวร ขอบคุณสำหรับการสนับสนุนเสมอมาค่ะ/ครับ",
