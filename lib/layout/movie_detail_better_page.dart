...
class MovieDetailPageBetter extends StatefulWidget {
  final Movie movie;
  ...
  const MovieDetailPageBetter({super.key, required this.movie, required this.captionFlag, required this.captionLan, required this.isCustomized, this.flag, this.cIdx});

  @override
  _MovieDetailPageBetterState createState() => _MovieDetailPageBetterState();
}

class _MovieDetailPageBetterState extends State<MovieDetailPageBetter> with WidgetsBindingObserver  {
  ...
  void dispose() {
    ...
    SystemChrome.setEnabledSystemUIMode(SystemUiMode.edgeToEdge);
    _betterPlayerController.dispose(); // 컨트롤러 해제
    super.dispose();
  }
